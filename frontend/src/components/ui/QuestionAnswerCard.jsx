      ...
      <div className="p-4 space-y-4">
        {options.map((label, idx)=> (
          <button
            ...
            className={'w-full h-12 rounded-md border px-4 text-left bg-[#F3F4F6] transition-shadow cursor-pointer hover:bg-white '+(selectedIndex===idx?'ring-2 ring-[#7C3AED] bg-white':'')}
          >
